...
const curriculumUrl = "https://cv.riannegreiros.dev";
...
async function generateMarkdown() {
  ...
  const curriculumBagde = `[![Curriculum Badge](https://img.shields.io/badge/-Curriculum-3B7EBF?style=for-the-badge&logo=file&logoColor=white)](${curriculumUrl})`;
